...
class VerificationScreen extends StatelessWidget {
  ...
  final FirebaseAuth auth_f=FirebaseAuth.instance;
                      ...
                      Padding(
                        ...
                        child: CustomButton(
                          ...
                          onTap: ()async {
                            ...
                            ///function to verify the otp entered by the userrrrrrrrrrrrr
                     /*       try{
                              PhoneAuthCredential credential = PhoneAuthProvider.credential(verificationId: SignUpWidget.verify, smsCode: code);
                              // Sign the user in (or link) with the credential
                              user_data=await auth_f.signInWithCredential(credential);
