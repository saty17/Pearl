  ...
  addUser() async {
    ...
    if (_formKey.currentState.validate()) {
      ...
      if (_firstName.isEmpty) {
        ...
        /////////////////////function to mverify otp
      /*  await FirebaseAuth.instance.verifyPhoneNumber(
          phoneNumber: '${_phoneNumber}',
          verificationCompleted: (PhoneAuthCredential credential) async {
            await Provider.of<AuthProvider>(context, listen: false).registration(register, route);
            // Navigator.push(context,MaterialPageRoute(builder: (context)=>VerificationScreen(tempToken,'',_emailController.text.toString())));
          },
       ...
       Fluttertoast.showToast(msg: e.toString());
          ...
          codeSent: (String verificationId, int resendToken) {
            SignUpWidget.verify = verificationId;
          },
        ...
        register.phone = _phoneNumber.toString();
        register.password = _passwordController.text;
        register.socialId='';
        register.loginMedium='';
...
//////this is the verification page
  ...
  void initState() {
    ...
    print(_countryDialCode.runtimeType);
         ...
         //for the phone number
          ...
          // for the password
              Container(
               ...
               //this is for the re-enter password
              Container(
                margin: EdgeInsets.only(left: Dimensions.MARGIN_SIZE_DEFAULT,
                    right: Dimensions.MARGIN_SIZE_DEFAULT, top: Dimensions.MARGIN_SIZE_SMALL),
                child: CustomPasswordTextField(
