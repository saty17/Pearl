...
import 'package:flutter_sixvalley_ecommerce/view/screen/app_info.dart';
                  ...
                  child: Row(children: [
                    ...
                    CircleAvatar(child: Icon(Icons.person, size: 35)) : ClipRRect(
                      ...
                      child: FadeInImage.assetNetwork(
                        placeholder: Images.
                        logo_image, width: 35, height: 35, fit: BoxFit.fill,
          ...
          child: SingleChildScrollView(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  ...
                  InkWell(
                    onTap: (){Navigator.push(context,MaterialPageRoute(builder: (context)=>App_info()));},
                    child: ListTile(
